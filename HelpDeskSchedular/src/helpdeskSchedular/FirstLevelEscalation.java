...
public class FirstLevelEscalation {
	...
	public static void main(String args[]) throws SQLException, Exception {
		try {
			...
			String toName = "Team";
			String subject = "1st Level Ticket Escalation";
			String emailid =null;
			List<String> toMailList =  new ArrayList<String>();
			String fromMail = hpcl_mail;
			ResultSet rs1=db.executeQuery("select emailid from Tbl_Hpcl_Hdesk_Users where roleId=7 and status='Y'");
			while (rs1.next()) {
